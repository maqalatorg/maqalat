  ...
  return (
    <div className="not-prose space-y-6 my-8">
      ...
      <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
        الجدول يتحدّث تلقائياً بحسب تاريخ اليوم — تاريخ منتهي يختفي، والقادم يظهر. القاعدة: راتب الحكومة والمتقاعدين في ٢٧ من كل شهر هجري، حساب المواطن في ١٠ ميلادي، الضمان المطوّر في ١ ميلادي. لو صادفت الجمعة أو السبت يُقدَّم الإيداع إلى الخميس.
      </p>
    </div>
  );
}
