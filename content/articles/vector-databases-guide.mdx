...
faq:
  ...
  - q: "أشهر Vector Databases 2026؟"
    a: "الأبرز: **Pinecone**، SaaS، الأشهر تجارياً، **Weaviate**، مفتوح المصدر، سحابي، **Chroma**، خفيف للتطوير، **Qdrant**، مفتوح، أداء عالٍ، **Milvus**، الأشمل للمؤسّسات. **Postgres + pgvector** بديل ممتاز إذا لديك Postgres."
  - q: "متى أستخدم Vector DB؟"
    a: "أشهرها: **RAG** (Retrieval Augmented Generation)، **بحث دلالي** (Semantic Search)، **أنظمة التوصيات** (منتجات مشابهة)، **البحث بالصور/الصوت المشابه**. **لا تحتاجها إذا**: بحث بسيط بالكلمات، بيانات صغيرة (&lt;10K)."
  - q: "الأداء؟ الأسعار؟"
