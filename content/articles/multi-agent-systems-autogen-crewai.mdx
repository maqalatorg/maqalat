...
description: "دليل لـMulti-Agent Systems: AutoGen (Microsoft)، CrewAI، LangGraph. متى تستخدمها، وأمثلة عملية — from autogen import AssistantAgent, UserProxyAgent"
cluster: "ai"
...
faq:
  ...
  - q: "متى نحتاجها؟"
    a: "من أهمّها: **مهمّة متعدّدة الخطوات** معقّدة، **تحتاج تخصّصات متعدّدة**، **قرارات مترابطة** (وكيل يعتمد على مخرج آخر)، **workflows موازية** (وكلاء يعملون في نفس الوقت). **بسيطة**: لا تحتاج."
  - q: "أشهر الأدوات؟"
    a: "الأبرز: **AutoGen** (Microsoft، مفتوح)، الأشمل، **CrewAI**، الأسهل، مبنيّ على الأدوار، **LangGraph** (LangChain)، قابل للتحكّم بدقّة. **الأنسب لك**: يعتمد على مشروعك."
  ...
  - q: "أمثلة استخدام؟"
    a: "أبرزها: **بحث + كتابة تقرير** (باحث + كاتب + مراجع)، **تطوير برمجي** (Product Manager + Developer + QA)، **خدمة عملاء** (فرز + متخصّص + مراجعة)، **تحليل مالي** (بيانات + تحليل + تقرير)، **حملة تسويقية** (بحث + إبداع + قياس)."
  - q: "التكلفة؟"
  ...
  - q: "المخاطر؟"
    a: "أبرزها: **الكلفة المتضاعفة**، **البطء** (خطوات متعدّدة)، **صعوبة التصحيح** (أيّ وكيل أخطأ؟)، **الاعتماد الزائد**، **الأمان** (كل وكيل نقطة هجوم محتمَلة). **الحلّ**: Monitoring دقيق، أدوات مثل LangSmith."
---
