...
description: "دليل تعليمي لـJailbreaking (كسر حواجز AI) و Red Teaming (فحص الأمان): الأساليب، الدفاعات، والاستخدام المسؤول — النماذج مدرَّبة على Refusals، رفض الأسئلة…"
cluster: "ai"
...
faq:
  ...
  - q: "ما أشهر أساليب Jailbreak؟"
    a: "أشهرها: **Role-playing** (لعب دور شخصية بلا حدود)، **DAN** (Do Anything Now، قديم لكن أشهر)، **Prompt Injection** (زرع تعليمات في نصّ)، **Encoding** (Base64، ROT13 لتجاوز فلاتر)، **Multi-turn** (بناء تدريجي عبر رسائل)."
  - q: "هل النماذج آمنة الآن؟"
    a: "أقوى بكثير من 2023، لكن **غير مثالية**. GPT-5.6 وClaude 5 يقاومان 95%+ من محاولات Jailbreak. لكن **تقنيات جديدة تظهر شهرياً**. الحلّ الدائم: **Layered Defense** (طبقات دفاع متعدّدة)، النموذج + فلاتر + مراقبة بشرية."
...
- الآن: قد يعمل جزئياً على النماذج الأصغر، فاشل على GPT-5.6/Claude 5
...
- GPT-5.6 وClaude 5 تحسّنت كثيراً
