...
description: "شرح تفصيلي لـRAG (Retrieval-Augmented Generation): كيف تربط LLM بمعرفتك الخاصّة، مع أمثلة بناء عملية — جمع المصادر: PDFs، Word، مواقع، قواعد بيانات 2."
cluster: "ai"
...
faq:
  ...
  - q: "متى أستخدم RAG؟"
    a: "منها: شات بوت شركتك يعرف وثائقك، بحث في PDFs الأكاديمية، مساعد قانوني في أنظمتك، FAQ ديناميكي، أيّ استخدام يحتاج النموذج معرفة **محدّدة** لا يعرفها من التدريب."
  ...
  - q: "ما تحدّيات RAG؟"
    a: "منها: جودة الاسترجاع، إذا لم يجد الأجزاء المناسبة، الجواب سيّئ، حجم Chunks، كبير جدّاً أو صغير جدّاً يضرّ، التكلفة، Embeddings + التخزين + الاستعلامات، التحديث، إضافة بيانات جديدة، الأمان، حماية بيانات المستخدمين المدمجة."
